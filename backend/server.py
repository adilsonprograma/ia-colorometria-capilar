...
from backend.estudo_capilar.chat_logic import INITIAL_PROMPT, process_input
from backend.estudo_capilar.models import ConversationState
...
STATIC_ROUTES = {
    ...
    "/index.js": FRONTEND_DIR / "index.js",
}
